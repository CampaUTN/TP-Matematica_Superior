...
function init()
  Inicio = figure;
  set (Inicio,"name","Trabajo PrÃ¡ctico - Matematica Superior");
...
function abrirMetodoCoeficientes (handlesource,event)
  ...
  botonExpresion = uicontrol (Coeficientes,"string","ExpresiÃ³n", ...
               "position",[10,200,150,35],"callback", ...
  ...
  botonExpresionCPG = uicontrol (Coeficientes,"string","ExpresiÃ³n CPG", ...
               "position",[200,140,150,35],"callback",...
  ...
  botonGraficar = uicontrol (Coeficientes,"string","Graficar ceros y polos", ...
               "position",[390,140,150,35],"callback",...
  ...
  botonEstabilidad = uicontrol (Coeficientes,"string","Indicar estabilidad", ...
               "position",[200,80,150,35],"callback",...
  ...
  botonTodo = uicontrol (Coeficientes,"string","Analizar todo", ...
               "position",[123,15,300,40],"callback",...
